      ...
      if (this.department.id) {
        this.departmentService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jhipsterFirstApplicationApp.department.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.departmentService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jhipsterFirstApplicationApp.department.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
