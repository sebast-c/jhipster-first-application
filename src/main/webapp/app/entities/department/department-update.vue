  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterFirstApplicationApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('jhipsterFirstApplicationApp.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterFirstApplicationApp.department.departmentName')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.department.location')"
