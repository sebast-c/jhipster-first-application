      ...
      if (this.employee.id) {
        this.employeeService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jhipsterFirstApplicationApp.employee.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.employeeService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jhipsterFirstApplicationApp.employee.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
