  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterFirstApplicationApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="t$('jhipsterFirstApplicationApp.employee.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterFirstApplicationApp.employee.firstName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.employee.lastName')" for="employee-lastName"></label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.employee.email')" for="employee-email"></label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.employee.phoneNumber')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.employee.hireDate')" for="employee-hireDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.employee.salary')" for="employee-salary"></label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.employee.commissionPct')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.employee.manager')" for="employee-manager"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.employee.department')"
