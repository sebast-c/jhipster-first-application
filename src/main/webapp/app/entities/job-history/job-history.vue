<template>
  <div>
    <h2 id="page-heading" data-cy="JobHistoryHeading">
      <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.home.title')" id="job-history-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'JobHistoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && jobHistories && jobHistories.length === 0">
      <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="jobHistories">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('startDate')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.startDate')"></span>
            ...
            <th scope="row" @click="changeOrder('endDate')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.endDate')"></span>
            ...
            <th scope="row" @click="changeOrder('language')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.language')"></span>
            ...
            <th scope="row" @click="changeOrder('job.id')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.job')"></span>
            ...
            <th scope="row" @click="changeOrder('department.id')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.department')"></span>
            ...
            <th scope="row" @click="changeOrder('employee.id')">
              <span v-text="t$('jhipsterFirstApplicationApp.jobHistory.employee')"></span>
        ...
        <tbody>
          <tr v-for="jobHistory in jobHistories" :key="jobHistory.id" data-cy="entityTable">
            ...
            <td v-text="t$('jhipsterFirstApplicationApp.Language.' + jobHistory.language)"></td>
            <td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="jhipsterFirstApplicationApp.jobHistory.delete.question"
          data-cy="jobHistoryDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-jobHistory-heading" v-text="t$('jhipsterFirstApplicationApp.jobHistory.delete.question', { id: removeId })"></p>
      </div>
