  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterFirstApplicationApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('jhipsterFirstApplicationApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterFirstApplicationApp.location.streetAddress')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.location.postalCode')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterFirstApplicationApp.location.stateProvince')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.location.country')" for="location-country"></label>
