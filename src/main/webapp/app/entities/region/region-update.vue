  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterFirstApplicationApp.region.home.createOrEditLabel"
          data-cy="RegionCreateUpdateHeading"
          v-text="t$('jhipsterFirstApplicationApp.region.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterFirstApplicationApp.region.regionName')" for="region-regionName"></label>
            <input
              type="text"
              class="form-control"
              name="regionName"
